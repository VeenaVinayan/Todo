      ...
      <div className='bg-black flex  flex-col justify-center items-center rounded m-2 p-10 min-h-screen'>
        ...
        <div className='items-center m-3 p-5 flex flex-row'>
           <div className='flex flex-col m-1 p-2'>
            <input type="text" value={todo} onChange={handleChange} className='bg-amber-50 text-black rounded border-amber-800 w-72 h-12 text-2xl'  />
        ...
        </div>
        {
            todos.length>0 && (
                ...
                <div className='flex flex-row'> 
                 <div className='  w-72 justify-around'>
                      { todos.map((todo :TTodo) => (
                         <div className='flex flex-row p-2 m-2 items-center border rounded border-amber-900 justify-around' key={todo.id}>
